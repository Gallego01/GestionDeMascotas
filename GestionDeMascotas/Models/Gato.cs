...
namespace GestionDeMascotas.Models
{
    public class Gato : Mascota, IVacunable
    {
        ...
        public Gato(int id, string nombre, string especie, string sexo, float peso, DateTime fechaNacimiento, int edadEnMeses, string raza, string color, bool vacunado) 
